#!groovy
/************************************************************************
***** Description :: This Custom Library is used for Pre Build step *****
***** Author      :: Mukul Garg                                     *****
***** Date        :: 04/24/2017                                     *****
***** Revision    :: 2.0                                            *****
************************************************************************/
     ...
     wrap([$class: 'AnsiColorBuildWrapper']) {
		  ...
		  if ( "${config.NPM_SCOPE}" != "null" ) {
            withCredentials([usernameColonPassword(credentialsId: 'git-credentials', variable: 'PUBLISH')]) {
			  def URL = "https://appx.tools.publicis.sapient.com/artifactory/api/npm/npm-release/auth/${config.NPM_SCOPE}"
